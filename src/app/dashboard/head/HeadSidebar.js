...
export default function HeadSidebar({ user, sidebarOpen, onClose }) {
  ...
  return (
    <div className="w-64 bg-gradient-to-br from-blue-50 to-indigo-50 shadow-lg border-r border-gray-200 flex flex-col h-full">
      {/* Header */}
